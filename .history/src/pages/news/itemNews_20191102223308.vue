...
export default {
    ...
    methods:
    {
        ...
        getNews()
        {
            this.$http.get("https://softwaredevelopmentproject.azurewebsites.net/api.v2/news/"+this.$route.params.id+'/').then((response) => {
        ...
        updateNews()
        {
            this.$http.put("https://softwaredevelopmentproject.azurewebsites.net/api.v2/news/"+this.$route.params.id+'/',this.news,{
                headers:{
